...
void different_size() {
  ...
  std::vector<std::string> dim = {"2", "5", "10", "15"};  
  std::vector<Color_t> colors = {kBlue, kRed, kGreen+2, kOrange};
  std::vector<Style_t> markers = {24, 24, 24, 24}; // cerchio, quadrato, triangolo, croce, asterisco
  int num_events = 1e6;
