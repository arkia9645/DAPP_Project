void fit_compton_edge() {
  ...
  comptonEdgeFit->SetParameters(1000, 400, 20, 10); // ampiezza, CE, sigma, fondo
 ...
 // Stampa il valore stimato della Compton edge con errore
double comptonEdge = comptonEdgeFit->GetParameter(1);
double comptonEdgeErr = comptonEdgeFit->GetParError(1);
std::cout << "Stima Compton Edge: " << comptonEdge << " ± " << comptonEdgeErr << " keV" << std::endl;
